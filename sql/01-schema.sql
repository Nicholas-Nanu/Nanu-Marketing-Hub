...
CREATE TABLE IF NOT EXISTS partnerships (
  ...
  type TEXT DEFAULT 'Organisation / Institution',
  status TEXT DEFAULT 'Lead / Prospect',
  owner TEXT REFERENCES users(id),
  contact_name TEXT DEFAULT '',
  contact_email TEXT DEFAULT '',
  value TEXT DEFAULT '',
...
CREATE POLICY "Allow all" ON partnerships FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all" ON chat_data FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE ambassadors ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow all" ON ambassadors FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE comm_channels ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow all" ON comm_channels FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE comm_events ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow all" ON comm_events FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all" ON engagement FOR ALL USING (true) WITH CHECK (true);

ALTER TABLE chat_last_read ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow all" ON chat_last_read FOR ALL USING (true) WITH CHECK (true);
