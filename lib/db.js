...
export async function loadAllData() {
  ...
  return {
    ...
    outreach: get(18).map(o => ({ id: o.id, name: o.name, type: o.type, platform: o.platform, status: o.status, owner: o.owner, notes: o.notes, url: o.url, date: o.date, contact_name: o.contactName || '', contact_email: o.contactEmail || '', linked_tasks: o.linkedTasks || [] })),
